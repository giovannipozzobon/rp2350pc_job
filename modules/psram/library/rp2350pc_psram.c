...
// *******************************************************************************************
//
//      Name :      rp2350pc_psram.c
//      Purpose :   Codee for PSRAM on the RP2350PC board
//      Date :      1st August 2025
//      Author :    Adafruit provided this code. I've no idea how it works.
//
// *******************************************************************************************
// *******************************************************************************************
...
/**
 * @brief      Set the QMI Timing
 *
 */
void __no_inline_not_in_flash_func(PSRHW_SetQMITiming)() {
...
/**
 * @brief      Attempt to detect the PSRAM chip
 *
 */
size_t __no_inline_not_in_flash_func(PSRHW_Detect)() {
    int psram_size = 0;
...
/**
 * @brief      Initialise PSRAM Chip
 *
 * @param[in]  cs_pin  Pin to use as Chip Select
 *
 * @return     Size of PSRAM Memory.
 */
size_t __no_inline_not_in_flash_func(PSRHW_Initialise)(uint cs_pin) {
    gpio_set_function(cs_pin, GPIO_FUNC_XIP_CS1);

    size_t psram_size = PSRHW_Detect();
